    ...
    <main className="w-screen h-screen relative">
      ...
      >
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          Full Stack Developer in the field MERN with expertise in delivering end-to-end solutions and a proven track record of developing high-quality applications. Skilled React Developer with a focus on building dynamic and responsive web applications.
          </p>
